...
final class WishlistApiController
{
    public function toggle(): void
    {
        ...
        $st = $pdo->prepare('SELECT id FROM wishlists WHERE user_id = ? AND vehicle_id = ? LIMIT 1');
        ...
        if ($row) {
            ...
            $ins = $pdo->prepare('INSERT INTO wishlists (user_id, vehicle_id) VALUES (?, ?)');
